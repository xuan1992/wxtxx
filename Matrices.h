...
inline void Matrix4::setColumn(int index, const float row[4])
{
...
inline void Matrix4::setRow(int index, const float col[4])
{
...
//    return os;
    ...
    << "[" << std::setw(10) << m[4] << " " << std::setw(10) << m[5] << " " << std::setw(10) << m[6]  <<  " " << std::setw(10) << m[7] << "]\n"
